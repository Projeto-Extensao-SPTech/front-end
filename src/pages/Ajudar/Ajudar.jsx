...
export default function Ajudar() {
    ...
    return (
        ...
        >
            ...
            <main className="relative z-10 w-full max-w-5xl mx-auto px-4 py-20 flex flex-col gap-16">

                <header className="text-center">
                    <h1
                        className="font-extrabold text-white tracking-tight"
                        style={{ fontSize: "clamp(32px, 5vw, 46px)", marginBottom: "14px" }}
                    >
                        Ajude e transforme vidas
                    </h1>
                    <p style={{ color: "rgba(255,255,255,0.48)", fontSize: "17px", maxWidth: "360px", margin: "0 auto", lineHeight: 1.65 }}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
                    <CardAjuda
                        ...
                        bgFim="#fef3c7"
                        icone={
                            <svg width="62" height="62" viewBox="0 0 24 24" fill="none" stroke="#f59e0b" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <CardAjuda
                        ...
                        bgFim="#dcfce7"
                        icone={
                            <svg width="62" height="62" viewBox="0 0 24 24" fill="none" stroke="#22c55e" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round">
